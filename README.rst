...
Document any optional config settings here. For example::
    ...
    # (optional, default: 24).
    ckanext.scorewater.some_setting = some_default_value
...
---------------------------------
Registering ckanext-scorewater on PyPI
---------------------------------

ckanext-scorewater should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-scorewater. If that link doesn't work, then
...
----------------------------------------
Releasing a New Version of ckanext-scorewater
----------------------------------------

ckanext-scorewater is availabe on PyPI as https://pypi.python.org/pypi/ckanext-scorewater.
